    ...
    <div className="min-h-screen relative overflow-hidden">
          ...
          >
            ...
            <div className="space-y-4 max-w-2xl mx-auto">
              <div className="flex items-start gap-3 text-left">
                ...
                <p className="text-lg">Sub-second quotes and low fees powered by Solana.</p>
              </div>
              <div className="flex items-start gap-3 text-left">
                <CheckCircle className="w-6 h-6 text-primary mt-1 flex-shrink-0" />
                <p className="text-lg">Wallet-first UX with secure, multi-wallet support.</p>
              </div>
              <div className="flex items-start gap-3 text-left">
                <CheckCircle className="w-6 h-6 text-primary mt-1 flex-shrink-0" />
                <p className="text-lg">Transparent routes, clear fees, and real-time status.</p>
              </div>
            </div>
            ...
            >
              <Card className="glass-card h-full hover:glow-effect transition-all">
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl">Speed & Low Fees</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            >
              <Card className="glass-card h-full hover:glow-effect transition-all">
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl">Wallet-First UX</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base">
            ...
            >
              <Card className="glass-card h-full hover:glow-effect transition-all">
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl">Transparent Routes</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base">
            ...
            >
              <Card className="glass-card h-full hover:glow-effect transition-all">
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl">Safety & Reliability</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base">
      ...
      <section className="py-20 px-4 bg-muted/20">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            <h2 className="text-4xl font-bold text-gradient mb-4">How Pegasus Swap Works</h2>
          </motion.div>
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-4 glass-card p-6 rounded-xl"
              >
      ...
      <section className="py-20 px-4 bg-muted/20">
        <div className="container mx-auto max-w-6xl">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gradient mb-4">Built for Speed, Trust, and Clarity</h2>
          </motion.div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gradient mb-4">Transparent Route Preview</h2>
